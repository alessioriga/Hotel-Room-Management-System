...
def insertValuesBookings():
    ...
    customerValues = [
        ...
        ("Alexis", "Stone", "28 Moorfield Crescent, Exeter, UK", "07700900031", "alexis.stone31@example.com"),
    ...
    bookingValues = [
        # Checked-in (status=2)
        (1, 1, 1, 1, 2, 600001, "06-02-2026", "08-02-2026", 1),  # Single, 2 nights, 1 guest
        (2, 11, 2, 2, 2, 600002, "06-02-2026", "09-02-2026", 2),  # Double, 3 nights, 2 guests
        (3, 21, 3, 1, 2, 600003, "06-02-2026", "09-02-2026", 2),  # Twin, 3 nights, 2 guests
        (4, 2, 4, 1, 2, 600004, "06-02-2026", "10-02-2026", 1),  # Single, 4 nights, 1 guest
        (5, 41, 5, 2, 2, 600005, "06-02-2026", "10-02-2026", 4),  # Family, 4 nights, 4 guests
        (6, 12, 6, 2, 2, 600006, "06-02-2026", "10-02-2026", 2),  # Double, 4 nights, 2 guests
        (7, 51, 7, 1, 2, 600007, "06-02-2026", "10-02-2026", 2),  # Suite, 4 nights, 2 guests
        (8, 31, 8, 2, 2, 600008, "06-02-2026", "11-02-2026", 3),  # Small Family, 5 nights, 3 guests
        (9, 22, 9, 1, 2, 600009, "06-02-2026", "11-02-2026", 2),  # Twin, 5 nights, 2 guests
        (10, 42, 10, 2, 2, 600010, "06-02-2026", "12-02-2026", 4), # Family, 6 nights, 4 guests

        # Arriving (status=1)
        (11, 3, 11, 1, 1, 600011, "06-02-2026", "09-02-2026", 1),   # Single, 3 nights
        (12, 13, 12, 2, 1, 600012, "06-02-2026", "10-02-2026", 2),   # Double, 4 nights
        (13, 23, 13, 2, 1, 600013, "06-02-2026", "10-02-2026", 2),   # Twin, 4 nights
        (14, 32, 14, 1, 1, 600014, "06-02-2026", "11-02-2026", 3),   # Small Family, 5 nights
        (15, 43, 15, 1, 1, 600015, "06-02-2026", "11-02-2026", 4),   # Family, 5 nights
        (16, 14, 16, 2, 1, 600016, "06-02-2026", "10-02-2026", 2),   # Double, 4 nights
        (17, 4, 17, 1, 1, 600017, "06-02-2026", "08-02-2026", 1),   # Single, 2 nights
        (18, 52, 18, 2, 1, 600018, "06-02-2026", "12-02-2026", 2),   # Suite, 6 nights
        (19, 24, 19, 2, 1, 600019, "06-02-2026", "11-02-2026", 2),   # Twin, 5 nights
        (20, 33, 20, 2, 1, 600020, "06-02-2026", "12-02-2026", 3),   # Small Family, 6 nights

        (21, 44, 21, 1, 1, 600021, "06-02-2026", "11-02-2026", 4),   # Family, 5 nights
        (22, 53, 22, 2, 1, 600022, "06-02-2026", "12-02-2026", 2),   # Suite, 6 nights
        (23, 5, 23, 1, 1, 600023, "06-02-2026", "12-02-2026", 1),   # Single, 6 nights
        (24, 15, 24, 2, 1, 600024, "06-02-2026", "13-02-2026", 2),   # Double, 7 nights
        (25, 25, 25, 1, 1, 600025, "06-02-2026", "12-02-2026", 2),   # Twin, 6 nights
        (26, 34, 26, 1, 1, 600026, "06-02-2026", "13-02-2026", 3),   # Small Family, 7 nights
        (27, 45, 27, 2, 1, 600027, "06-02-2026", "12-02-2026", 4),   # Family, 6 nights
        (28, 54, 28, 2, 1, 600028, "06-02-2026", "13-02-2026", 2),   # Suite, 7 nights
        (29, 35, 29, 1, 1, 600029, "06-02-2026", "12-02-2026", 3),   # Small Family, 6 nights
        (30, 26, 30, 1, 1, 600030, "06-02-2026", "13-02-2026", 2),   # Twin, 7 nights

        (31, 16, 31, 2, 1, 600031, "06-02-2026", "12-02-2026", 2),   # Double, 6 nights
        (32, 6, 32, 1, 1, 600032, "06-02-2026", "13-02-2026", 1),   # Single, 7 nights
        (33, 55, 33, 2, 1, 600033, "06-02-2026", "12-02-2026", 2),   # Suite, 6 nights
        (34, 36, 34, 1, 1, 600034, "06-02-2026", "13-02-2026", 3),   # Small Family, 7 nights
        (35, 27, 35, 2, 1, 600035, "06-02-2026", "12-02-2026", 2),   # Twin, 6 nights
        (36, 46, 36, 2, 1, 600036, "06-02-2026", "13-02-2026", 4),   # Family, 7 nights
        (37, 56, 37, 1, 1, 600037, "06-02-2026", "12-02-2026", 2),   # Suite, 6 nights
        (38, 37, 38, 2, 1, 600038, "06-02-2026", "13-02-2026", 3),   # Small Family, 7 nights
        (39, 17, 39, 2, 1, 600039, "06-02-2026", "12-02-2026", 2),   # Double, 6 nights
        (40, 7, 40, 1, 1, 600040, "06-02-2026", "13-02-2026", 1)    # Single, 7 nights
    ]
...
# createHotelTable()
# insertValueUser()
# insertValuesBookings()import sqlite3 as db
